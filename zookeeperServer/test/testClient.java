...
public class testClient {
    ...
    private void createZKInstance() throws IOException {
        // 连接到ZK服务，多个可以用逗号分割写
        //zk = new ZooKeeper("192.168.19.130:2181,192.168.19.130:2182,192.168.19.130:2183", testClient.SESSION_TIMEOUT, this.wh);
        zk = new ZooKeeper("127.0.0.1:2181", testClient.SESSION_TIMEOUT, this.wh);
